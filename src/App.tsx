...
function App(){
  ...
  return <div className="app">
    ...
    {view!=='Home'&&<SocialPanel view={view} onClose={()=>setView('Home')}/>} {selectedPost&&<PostThread post={selectedPost} onClose={()=>setSelectedPost(null)}/>} {toast&&<div className="toast" role="status">{toast}</div>}
  </div>
}
